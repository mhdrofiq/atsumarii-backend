-- Sample data for Atsumarii application (Safe for restarts)
-- Uses INSERT IGNORE or ON DUPLICATE KEY UPDATE to prevent conflicts

-- Insert sample users (will not conflict on restart)
INSERT IGNORE INTO t_users (userid, username, fullname, email, dateofbirth, bio, profileimgurl, createdat) VALUES
...
-- Insert sample groups (will not conflict on restart)
INSERT IGNORE INTO t_groups (groupid, groupname, description, groupimgurl, createdat, creatorid) VALUES
...
-- Insert group memberships (will not conflict on restart)
INSERT IGNORE INTO t_group_membership (membershipid, joinedat, userid, groupid) VALUES
-- Alice's memberships
...
-- Insert sample events (will not conflict on restart)
INSERT IGNORE INTO t_events (eventid, eventname, tags, description, eventimgurl, location, start, end, createdat, groupid) VALUES
...
-- Insert event attendances (will not conflict on restart)
INSERT IGNORE INTO t_event_attendance (attendanceid, attendance_status, registeredat, eventid, userid) VALUES
